...
TAKER_FEE_PCT = 0.0031
TAKER_SELL_FEE_PCT = 0.0030
MAKER_FEE_PCT = 0.0020
SELL_TAX_PCT = 0.0021
CFX_FEE_PCT = 0.000111
TOTAL_MAKER_ROUNDTRIP_PCT = MAKER_FEE_PCT + MAKER_FEE_PCT + SELL_TAX_PCT + CFX_FEE_PCT
TOTAL_TAKER_ROUNDTRIP_PCT = TAKER_FEE_PCT + TAKER_SELL_FEE_PCT + SELL_TAX_PCT + CFX_FEE_PCT
...
CIRCUIT_BREAKER_HOURS = 72
EQUITY_FLOOR_IDR = 10_000
...
AI_OPTIMIZER_ATR_SL_MIN = 1.0
AI_OPTIMIZER_ATR_SL_MAX = 2.5
AI_OPTIMIZER_ATR_TP_MIN = 1.0
AI_OPTIMIZER_ATR_TP_MAX = 3.0
AI_OPTIMIZER_MAX_DAILY_TRADES_MIN = 5
AI_OPTIMIZER_MAX_DAILY_TRADES_MAX = 50
